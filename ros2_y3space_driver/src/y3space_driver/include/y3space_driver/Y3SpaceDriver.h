...
// class Y3SpaceDriver : public rclcpp::Node, public SerialInterface
...
public:
    ...
    // Y3SpaceDriver(rclcpp::Node::SharedPtr nh, rclcpp::Node::SharedPtr pnh, 
    //                 std::string port, int baudrate, int timeout, 
    //                 std::string mode, std::string frame);
    // Y3SpaceDriver(std::string port, int baudrate, int timeout, std::string mode, std::string frame);
     Y3SpaceDriver();
        // ros::NodeHandle& nh, ros::NodeHandle& pnh, std::string port, int baudrate, int timeout, std::string mode, std::string frame);
    //!
    //! Destructor
    //!
    ~Y3SpaceDriver();
...
private:
    ...
    rclcpp::Publisher<sensor_msgs::msg::Imu>::SharedPtr m_raw_imu_pub;  ///< Publisher for IMU messages
